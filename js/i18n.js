...
const DICT = {
  ...
  uz: {
    ...
    "filter.label": "Turlari",
    "filter.all": "Hammasi",
    "search.placeholder": "Qidirish…",
    "search.none": "«{q}» bo‘yicha hech nima topilmadi.",
    "search.clear": "Tozalash",
    "print.btn": "Chop etish",
    "event.fCategory": "Turi",
    "event.fRepeat": "Takrorlanish",
    "rec.none": "Takrorlanmaydi",
    "rec.daily": "Har kuni",
    "rec.weekly": "Har hafta",
    "rec.monthly": "Har oy",
    "rec.yearly": "Har yili",
    "rec.interval": "Nechada bir",
    "rec.until": "Qachongacha",
    "rec.untilNone": "Muddatsiz",
    "rec.badge": "takrorlanadi",
    "rec.every": "Har {n} marta",
    "rec.seriesNote": "Bu takrorlanuvchi tadbir. O‘zgartirish barcha sanalariga tegadi.",
    "rec.deleteTitle": "Nimani o‘chiramiz?",
    "rec.deleteOne": "Faqat shu sanani",
    "rec.deleteAll": "Butun turkumni",
    "rec.errUntil": "Tugash sanasi boshlanishdan keyin bo‘lsin.",
    "rec.skipped": "Shu sana turkumdan chiqarildi",
    "multi.continues": "davomi",
    "multi.dayOf": "{i}/{n}-kun",
    "multi.span": "{n} kun davom etadi",
    "restore.btn": "Tiklash",
    "restore.done": "Tadbir tiklandi",
    "restore.confirm": "«{title}» tiklansinmi?",
    "setup.title": "Sozlash kerak",
    "setup.body": "config.js hali to‘ldirilmagan, shuning uchun taqvim ma’lumot topolmayapti.",
    "setup.s1": "Gist yarating va uning ID sini oling",
    "setup.s2": "tools/hash.html orqali token va admin parolini tayyorlang",
    "setup.s3": "config.js ga uchalasini yozing va repoga push qiling",
    "setup.hint": "To‘liq yo‘riqnoma README.md da.",
  },
  ...
  ru: {
    ...
    "search.none": "По запросу «{q}» ничего не найдено.",
    "search.clear": "Очистить",
    "print.btn": "Печать",
    "event.fCategory": "Тип",
    "event.fRepeat": "Повтор",
    "rec.none": "Не повторяется",
    "rec.daily": "Каждый день",
    "rec.weekly": "Каждую неделю",
    "rec.monthly": "Каждый месяц",
    "rec.yearly": "Каждый год",
    "rec.interval": "Через сколько",
    "rec.until": "До какой даты",
    "rec.untilNone": "Без срока",
    "rec.badge": "повторяется",
    "rec.every": "Каждый {n}-й раз",
    "rec.seriesNote": "Это повторяющееся событие. Изменения затронут все даты.",
    "rec.deleteTitle": "Что удалить?",
    "rec.deleteOne": "Только эту дату",
    "rec.deleteAll": "Всю серию",
    "rec.errUntil": "Дата окончания должна быть позже начала.",
    "rec.skipped": "Дата исключена из серии",
    "multi.continues": "продолжение",
    "multi.dayOf": "день {i} из {n}",
    "multi.span": "Длится {n} дн.",
    "restore.btn": "Восстановить",
    "restore.done": "Событие восстановлено",
    "restore.confirm": "Восстановить «{title}»?",
    "setup.title": "Нужна настройка",
    "setup.body": "config.js ещё не заполнен, поэтому календарь не находит данные.",
    "setup.s1": "Создайте gist и скопируйте его ID",
    "setup.s2": "Через tools/hash.html подготовьте токен и пароль администратора",
    "setup.s3": "Впишите всё три значения в config.js и запушьте в репозиторий",
    "setup.hint": "Полная инструкция — в README.md.",
  },
  ...
  en: {
    ...
    "search.clear": "Clear",
    "print.btn": "Print",
    "event.fCategory": "Type",
    "event.fRepeat": "Repeat",
    "rec.none": "Doesn't repeat",
    "rec.daily": "Every day",
    "rec.weekly": "Every week",
    "rec.monthly": "Every month",
    "rec.yearly": "Every year",
    "rec.interval": "Every nth",
    "rec.until": "Until",
    "rec.untilNone": "No end date",
    "rec.badge": "repeats",
    "rec.every": "Every {n}",
    "rec.seriesNote": "This event repeats. Changes apply to every date in the series.",
    "rec.deleteTitle": "What should be deleted?",
    "rec.deleteOne": "Only this date",
    "rec.deleteAll": "The whole series",
    "rec.errUntil": "The end date must come after the start.",
    "rec.skipped": "That date was removed from the series",
    "multi.continues": "continues",
    "multi.dayOf": "day {i} of {n}",
    "multi.span": "Runs for {n} days",
    "restore.btn": "Restore",
    "restore.done": "Event restored",
    "restore.confirm": "Restore “{title}”?",
    "setup.title": "Setup needed",
    "setup.body": "config.js hasn't been filled in, so the calendar can't find its data.",
    "setup.s1": "Create a gist and copy its ID",
    "setup.s2": "Use tools/hash.html to prepare the token and admin password",
    "setup.s3": "Put all three values in config.js and push to the repo",
    "setup.hint": "Full instructions are in README.md.",
  },
  ...
  zh: {
    ...
    "rec.badge": "重复",
    "rec.every": "每 {n} 次",
    "rec.seriesNote": "这是重复活动，修改会影响所有日期。",
    "rec.deleteTitle": "要删除什么？",
    "rec.deleteOne": "仅这一天",
    "rec.deleteAll": "整个系列",
    "rec.errUntil": "截止日期必须晚于开始日期。",
    "rec.skipped": "该日期已从系列中移除",
    "multi.continues": "续",
    "multi.dayOf": "第 {i}/{n} 天",
    "multi.span": "持续 {n} 天",
    "restore.btn": "恢复",
    "restore.done": "活动已恢复",
    "restore.confirm": "恢复「{title}」？",
    "setup.title": "需要配置",
    "setup.body": "config.js 尚未填写，日历找不到数据。",
    "setup.s1": "创建一个 gist 并复制它的 ID",
    "setup.s2": "用 tools/hash.html 生成令牌和管理员口令",
    "setup.s3": "把三项都写进 config.js 并推送到仓库",
    "setup.hint": "完整说明见 README.md。",
  },
};
